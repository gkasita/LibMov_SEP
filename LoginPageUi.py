...
"padding-bottom: 8px;")
        ...
        self.loginButton.setGeometry(QRect(200, 430, 161, 41))
        font = QFont()
        font.setFamilies([u"Verdana"])
        font.setPointSize(18)
        self.loginButton.setFont(font)
        self.loginButton.setStyleSheet(u"background-color: rgb(131, 16, 16);\n"
"border-radius: 15px;")
...
"padding-bottom: 8px;")
        ...
        self.errorLabel.setGeometry(QRect(120, 400, 311, 20))
        ...
        self.signupButton.setGeometry(QRect(120, 370, 161, 41))

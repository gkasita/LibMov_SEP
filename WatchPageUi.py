...
"color: rgb(131, 16, 16);")
        ...
        self.addBT = QPushButton(self.frame_2)
        self.addBT.setObjectName(u"addBT")
        self.addBT.setStyleSheet(u"background-color: rgb(131, 16, 16);")

        self.verticalLayout_2.addWidget(self.addBT)

        self.delBT = QPushButton(self.frame_2)
        self.delBT.setObjectName(u"delBT")
        self.delBT.setStyleSheet(u"background-color: rgb(131, 16, 16);")

        self.verticalLayout_2.addWidget(self.delBT)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.addBT.setText(QCoreApplication.translate("Form", u"Add", None))
        self.delBT.setText(QCoreApplication.translate("Form", u"Delete", None))
